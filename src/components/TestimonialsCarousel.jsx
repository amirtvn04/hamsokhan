    ...
    >
      {testimonials.map((test, index) => (
        <SwiperSlide key={index}>
          <div className='flex items-center bg-white border border-black/15 rounded-lg px-6 pt-13 pb-5 relative mt-10 hover:border-[#0065F4] transition duration-200'>
            <img className='w-20 h-20 rounded-full absolute -top-10 right-5' src={`./img/${test.gender === "male" ? "male" : "female"}comment.webp`} alt="#" />
            <div>
